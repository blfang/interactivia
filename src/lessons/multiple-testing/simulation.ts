...
// the z-score cutoff for a two-sided test with significance level alpha/m
export function bonferroniCutoff(m: number, alpha: number = 0.05): number {
  return invNorm(1 - alpha / (2 * m));
}
